# The incident
The Goodput Simulator is here to put you in my shoes for a day. It recreates a production incident pattern from the first week of deploying a self-hosted Anthropic model in our air-gapped environment, whose simplest solution was to let fewer users in at a time.
